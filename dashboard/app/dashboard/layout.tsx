    ...
    <Providers>
      <div className="h-screen flex flex-col overflow-hidden">
        <header className="h-12 border-b border-[#E8E4E0] bg-white flex items-center px-4 shrink-0">
          <a href="/" className="text-sm font-semibold text-[#2D2D2D] hover:text-[#3D405B]">Immo Scouter</a>
          <a href="/dashboard" className="ml-6 text-sm font-medium text-[#3D405B] hover:text-[#2D2D2D]">Listings</a>
