...
| **GLOBAL_VALIDATION** | Single source of truth for listing validation thresholds: min_price_total (€50k), min_area_m2 (30), min_price_per_m2 (€2000), max_price_per_m2 (€20k). |
