                ...
                if data.get('ok') and data.get('result'):
                    for update in data['result']:
                        if 'message' in update:
                            ...
                            print()
                            print("📝 Update your telegram_config.json with this chat ID!")
                            return chat['id']
...
def main():
    # Load current config
    try:
        with open('immo-scouter/telegram_config.json', 'r') as f:
            config = json.load(f)
        ...
        if new_chat_id:
            ...
            print(f"✅ Updated telegram_config.json with chat ID: {new_chat_id}")
            print()
